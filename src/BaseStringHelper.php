...
class BaseStringHelper
{
    ...
    {
        if ($asHtml) {
            return static::truncateHtml($string, $length, $suffix, $encoding ?: cui::$app->charset);
        }

        if (mb_strlen($string, $encoding ?: cui::$app->charset) > $length) {
            return rtrim(mb_substr($string, 0, $length, $encoding ?: cui::$app->charset)) . $suffix;
        } else {
            return $string;
        }
    }
    ...
    protected static function truncateHtml($string, $count, $suffix, $encoding = false)
    {
        ...
        $config->set('Cache.SerializerPath', \cui::$app->getRuntimePath());
    ...
    public static function startsWith($string, $with, $caseSensitive = true)
    {
        ...
        if ($caseSensitive) {
            ...
            return mb_strtolower(mb_substr($string, 0, $bytes, '8bit'), cui::$app->charset) === mb_strtolower($with, cui::$app->charset);
        }
    }
    ...
    public static function endsWith($string, $with, $caseSensitive = true)
    {
        ...
        if ($caseSensitive) {
            ...
            return mb_strtolower(mb_substr($string, -$bytes, mb_strlen($string, '8bit'), '8bit'), cui::$app->charset) === mb_strtolower($with, cui::$app->charset);
        }
    }
