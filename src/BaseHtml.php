...
class BaseHtml
{
    ...
    {
        return htmlspecialchars($content, ENT_QUOTES | ENT_SUBSTITUTE, cui::$app ? cui::$app->charset : 'UTF-8', $doubleEncode);
    }
    ...
    {
        $header = isset($options['header']) ? $options['header'] : '<p>' . cui::t('cui', 'Please fix the following errors:') . '</p>';
     ...
     * if `'data' => ['id' => 1, 'name' => 'cui']`, then this will be rendered:
     * `data-id="1" data-name="cui"`.
     * Additionally `'data' => ['params' => ['id' => 1, 'name' => 'cui'], 'status' => 'ok']` will be rendered as:
     * `data-params='{"id":1,"name":"cui"}' data-status="ok"`.
     *
    ...
    public static function getAttributeValue($model, $attribute)
    {
        ...
        // https://github.com/cuisoft/cui2/issues/1457
        if (is_array($value)) {
